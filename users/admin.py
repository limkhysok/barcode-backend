...
class AdminActionLogInline(admin.TabularInline):
    ...
    readonly_fields = ('action_time', 'action_flag_display', 'content_type', 'object_repr', 'change_message')
    fields = ('action_time', 'action_flag_display', 'content_type', 'object_repr', 'change_message')
